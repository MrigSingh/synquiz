            ...
            <Grid item xs={12} md={8} lg={9}>
              <Paper className={fixedHeightPaper}>
                ...
                <Typography component="p" variant="h4">
                  Great Job ! Looks like your product is appealing more customers <span role="img" aria-label="emoji" >😍</span>. We have few more users onboard since last week. Keep up your great work.<span role="img" aria-label="emoji">🔥</span>
                </Typography>
              </Paper>
            </Grid>
            {/* Recent Deposits */}
                    ...
                    <TableBody>
                      {users.length !== 0 ? users.map((row) => (
                        <StyledTableRow key={row.name}>
                          ...
                          <StyledTableCell>{row.stream}</StyledTableCell>
                        </StyledTableRow>
                      )): <h2>Fetching data...</h2>}
                    </TableBody>
                  </Table>
